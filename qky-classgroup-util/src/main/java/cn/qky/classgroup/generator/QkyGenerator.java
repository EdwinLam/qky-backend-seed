package cn.qky.classgroup.generator;
...
public class QkyGenerator {
    private static final String packageName = "cn.qky.classgroup";
     ...
     * 建议仅需修改
     */
    private static final String className = "BasUser";

    /**
     * 类说明描述
     * 建议仅需修改
     */
    private static final String description = "用户基本信息";
     ...
     * 实体类对应包
     */
    private static final String entityPackage = packageName + ".entity";

    /**
     * dao对应包
     */
    private static final String daoPackage = packageName + ".dao";

    /**
     * service对应包
     */
    private static final String servicePackage = packageName + ".service";

    /**
     * serviceImpl对应包
     */
    private static final String serviceImplPackage = packageName + ".service.impl";

    /**
     * controller对应包
     */
    private static final String controllerPackage = packageName + ".controller";
    ...
    public static void main(String[] args) throws IOException {
        ...
        //模板路径
        String root = System.getProperty("user.dir") + "/qky-classgroup-util/src/main/java/" + packagePath + "/generator/template";
    ...
    private static void generateCode(GroupTemplate gt) throws IOException {
        ...
        //创建文件
        String entityFileUrl = System.getProperty("user.dir") + "/qky-classgroup-entity/src/main/java/" + packagePath + "/entity/" + className + ".java";
        ...
        log.info(daoResult);
        //创建文件
        String daoFileUrl = System.getProperty("user.dir") + "/qky-classgroup-service/src/main/java/" + packagePath + "/dao/" + className + "Dao.java";
        ...
        //创建文件
        String serviceFileUrl = System.getProperty("user.dir") + "/qky-classgroup-service/src/main/java/" + packagePath + "/service/" + className + "Service.java";
        ...
        //创建文件
        String serviceImplFileUrl = System.getProperty("user.dir") + "/qky-classgroup-service/src/main/java/" + packagePath + "/service/impl/" + className + "ServiceImpl.java";
        ...
        //创建文件
        String controllerFileUrl = System.getProperty("user.dir") + "/qky-classgroup-web/src/main/java/" + packagePath + "/controller/" + className + "Controller.java";
